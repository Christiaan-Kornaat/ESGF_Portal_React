...
export default class PresetCustomiserWrapper extends ColumnedPage<PresetCustomiserProps> {
    ...
    public state: PresetCustomiserState;
    ...
    constructor(props: PresetCustomiserProps) {
        super(props);
